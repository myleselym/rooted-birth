  ...
  return (
    ...
    >
      <Image
        ...
        width={290}
      />
      <div className="w-[500px] px-2 text-lg flex flex-col gap-4">
        ...
        <p>
          ...
          <span className="mx-1 text-violet-500">integrity</span>and sustains my
          passion for justice.
          <br />
          As a doula and birth strategist, I utilize the body&apos;s physiology,
          neuroscience, and trust in the client&apos;s intuition and ability to
          make informed decisions as a means to increase the likelihood of
          positive birth outcomes, as defined by the birthing person.
        </p>
        {button && (
          <Link
            href="/about"
